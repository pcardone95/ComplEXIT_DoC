...
save('alpha_KET_V3.mat','res_alpha_merged_table_old')
...
save('alpha_KET_V4.mat','res_alpha_merged_table')
writetable(res_alpha_merged_table, 'pilotKET_merged_R_alpha_v4.txt')
