...
data_LZC_allcon_path <- 'pilotKET_merged_R_V2_all.txt'
data_PerCon_path <- 'pilotKET_merged_R_V2_PerConc.txt'
data_alpha_path <-  'pilotKET_merged_R_alpha_v2.txt'
...
MAS_graph_mod + facet_nested(Condition ~ Subject + Side)
