...
writetable(temp_all_merged, 'pilotKET_merged_R_V2_all.txt')
writetable(temp_PerConc_merged, 'pilotKET_merged_R_V2_PerConc.txt')
save('pilotKET_merged_V2.mat', 'temp_all_merged', 'temp_PerConc_merged')